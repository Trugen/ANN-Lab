...
class RCCAModule(Module):
    ...
    def execute(self, x, recurrence=1):
        ...
        # print('INPUT:', (jt.concat([x, output], 1).shape))
...
class VAN(nn.Module):
    def __init__(self, img_size=224, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
        ...
        self.head = RCCAModule(512, 128, num_classes)  # * edition here
    ...
    def reset_classifier(self, num_classes, global_pool=''):
        self.num_classes = num_classes
        self.head = RCCAModule(512, 128, num_classes) if num_classes > 0 else nn.Identity()
